...
|ログイン/ログアウト機能|ログインとログアウトができるようにするため|ログインとログアウトを可能にする||
|節約術投稿/削除機能|節約術を投稿できたりする。削除機能は、自分の投稿のみ削除可能で、投稿した記事にマウスを載せると削除ボタンが現れる|||
|ページネーション機能|ユーザー登録をしてマイページを持てるようにするため|||
|マイページ機能||||
|家計簿登録/削除機能||||
|家計簿の詳細入力欄の追加と削除機能||||
|月別/日別検索機能||||
