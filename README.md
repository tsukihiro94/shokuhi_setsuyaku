...
----|----|----|----|----| 
| ユーザー登録機能 |ユーザー登録をしてマイページを持てるようにするため|deviseを利用して、ユーザー登録を可能にする|トップページのヘッダーにある「新規登録」ボタンを押し、入力フォームに従って入力する。最後に「登録」ボタンを押す|

 | 実装した機能 | 目的 | 詳細 | ストーリー（ユースケース） |
----|----|----|----|----| 
| ユーザー情報編集機能 |ユーザー登録をしてマイページを持てるようにするため|deviseを利用して、ユーザー登録を可能にする|トップページのヘッダーにある「新規登録」ボタンを押し、入力フォームに従って入力する。最後に「登録」ボタンを押す|
